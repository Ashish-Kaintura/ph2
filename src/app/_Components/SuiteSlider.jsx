...
import Img1 from "/public/Images/suits/Studio-suiets.jpg"
import Img2 from "/public/Images/suits/Family-suites4.jpg"
...
// Sample room data
const rooms = [
  { name: "Studio SUITE", image: Img1 },
  { name: "Family Deluxe SUITE", image: Img2 },
    ...
    <>
      <div className="py-12 sm:ps-28 relative">
        ...
        <div className="flex justify-center mt-1">
          <h2 className=" font-raleway tracking-widest text-[#7b5b20] text-sm uppercase" >{rooms[currentIndex].name} </h2>
        </div>
